     ...
     <header>
        <div class="container">
             <nav class="nav">
                 ...
                 <a href="index.html" class="logo"><img src="logo-phoenix.png" alt=""></a>
                 <ul class="nav-list">
                     <li class="nav-item">
                 ...
                 <div class="single-animation">
                     ...
                     <?php
                        if (isset($_SESSION["useruid"])){
                            echo "<br><br><br>";
                            echo "<p style = \"color:white;\">You are logged in as: " . $_SESSION["useruid"] ."</p>";
                        }
                    ?>
                 </div>
             </div>
...
este oaza ta de relaxare in mijlocul naturii
Astfel, fie ca esti in cautarea unui loc fermecator, in care sa petreci
momente frumoase alaturi de cei dragi sau ca organizezi un
eveniment privat sau de firma, Phoenix Cernica are solutia pentru tine!
                     </p>
                     <a href="#" class="btn body-btn">About us</a>
                 </div>
                 <div class="complex-info-img animate-right">
                     <img src="drona.jpeg" alt="">
                 </div>
             </div>
         </div>
     </section>
        ...
        <div class="container">
            <div class="complex-info">
                <div class="image-group padding-right animate-left">
                    <img src="discoverphoenix.jpeg" alt="">
                    <img src="discovernuntapelac.jpeg" alt="">
...
eveniment privat sau de firma, Phoenix Cernica are solutia pentru tine!
                ...
                <div class="image-group ">
                    <img class="animate-top" src="masa3.jpeg" alt="">
                    <img class="animate-bottom" src="masa1.jpeg" alt="">
                </div>
            </div>
        </div>
    </section>
